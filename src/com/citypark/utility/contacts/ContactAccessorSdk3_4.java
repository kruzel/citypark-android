 ...
 * 
 */
package com.citypark.utility.contacts;
...
public class ContactAccessorSdk3_4 extends AbstractContactAccessor {
	...
	/* (non-Javadoc)
	 * @see com.citypark.ContactAccessor#getPickContactIntent()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.citypark.ContactAccessor#loadContact(android.content.ContentResolver, android.net.Uri)
	 */
	@Override
