...
public class Distance {
	 ...
	 */
	public static double calculateDistance(Address pointA, Address pointB,
			int units) {
	...
	public static double calculateDistance(GeoPoint pointA, GeoPoint pointB,
			int units) {
		float latitude = (float) (pointA.getLatitudeE6() / 1E6);
		float longitude = (float) (pointA.getLongitudeE6() / 1E6);
		float latitudeb = (float) (pointB.getLatitudeE6() / 1E6);
		float longitudeb = (float) (pointB.getLongitudeE6() / 1E6);
